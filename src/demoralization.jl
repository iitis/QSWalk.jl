...
If the first argument is of type `Vector{Vertex}`, then default block matrix `eye`.
...
should equal one. The keys of `init_vertices` should be a subset of `vertexset()`.
